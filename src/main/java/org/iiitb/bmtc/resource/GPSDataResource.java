...
import org.iiitb.bmtc.service.dataServices.GPSDataService;
...
public class GPSDataResource {
	...
	public Response getGPSdata(@Context UriInfo uriInfo, @PathParam("busStopNumber") int busStopNumber) {
		...
		String Direction = "nagarabhavi bda complex nagarabhavi 2nd stage beside bda complex nagarabhavi to cv raman nagara";//queryParam.get("direction").get(0);
		String date = "13/06/2016";//queryParam.get("date").get(0);
